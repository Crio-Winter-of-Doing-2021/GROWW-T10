                        ...
                        {paginatedStocks.map((stock) => {
                            return (
                                ...
                                >
                                    ...
                                    <TableCell>
                                        $ {getCommaFormat(stock.lastPrice)}
                                    </TableCell>
                                    <TableCell>

                                        {<Typography color={stock.change > 0 ? "primary" : "error"}>{stock.change} ( {stock.changePercent} % ) </Typography>}
                                    </TableCell>
                                    <TableCell>
                                        $ {getCommaFormat(stock.yesterdayClose)}
                                    </TableCell>
                                    <TableCell>
